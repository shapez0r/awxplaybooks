...
### 🔧 Исправления
- **КРИТИЧЕСКОЕ ИСПРАВЛЕНИЕ**: Решена проблема с PowerShell ScriptBlock
- Исправлена ошибка "ScriptBlock should only be specified as a value of the Command parameter"
- Упрощена логика создания директорий - убраны сложные условия с фигурными скобками
- Переписан executor script - используется упрощенная версия без сложных конструкций
- Улучшено создание скрипта через base64 и Out-File

### 🚀 Улучшения
- Более надежное выполнение PowerShell команд
- Устранены проблемы с экранированием фигурных скобок
- Добавлен тестовый плейбук `winbatch_v2_test_powershell_fix.yml`
